class Game {
     ...
     * @param {Food} food
     */
    init(settings, status, score, board, snake, menu, food) {
     ...
     */
    isGameLost() {
        if (this.snake.isSnakeEatsItself()) {
            clearInterval(this.tickIdentifier);
    ...
    /**
     * Метод выводит счёт на странице.
     */
    setScore() {
        this.scoreEl.innerText = this.score.scoreValue;
    }
}