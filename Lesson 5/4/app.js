...
detailButtons.forEach((detailBtn) => {
    detailBtn.addEventListener('click', handleClick);
});
...
function showMoreText(card) {
    ...
    const descText = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, expedita id harum pariatur dolores minima.';
